...
#include "flashlight/app/asr/augmentation/sox/Effects.h"
#include "flashlight/app/asr/augmentation/sox/EffectsChain.h"
#include "flashlight/app/asr/augmentation/sox/Utils.h"

using namespace fl::sox_utils;
...
//   fl::sox_effects_chain::SoxEffectsChain chain(
...
//   return std::tuple<std::vector<float>, int64_t>(
...
//   //
//   // * This can be changed with `fl.utils.sox_utils.set_buffer_size`.
//   auto capacity =
...
//   m.def(
//       "fl::sox_effects_initialize_sox_effects",
//       &fl::sox_effects::initialize_sox_effects);
//   m.def(
//       "fl::sox_effects_shutdown_sox_effects",
//       &fl::sox_effects::shutdown_sox_effects);
//   m.def(
//       "fl::sox_effects_apply_effects_tensor",
//       &fl::sox_effects::apply_effects_tensor);
//   m.def(
//       "fl::sox_effects_apply_effects_file",
//       &fl::sox_effects::apply_effects_file);
// }
