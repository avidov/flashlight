...
#include "flashlight/app/asr/augmentation/sox/Io.h"
...
//   return fl::sox_effects::apply_effects_file(
...
std::tuple<std::vector<float>, int64_t> load_audio_fileobj(
    ...
    std::optional<std::string>& format) {
  auto effects = get_effects(frame_offset, num_frames);
  return fl::sox_effects::apply_effects_fileobj(
...
//   m.def("fl::sox_io_get_info", &fl::sox_io::get_info_file);
//   m.def(
//       "fl::sox_io_load_audio_file",
//       &fl::sox_io::load_audio_file);
//   m.def(
//       "fl::sox_io_save_audio_file",
//       &fl::sox_io::save_audio_file);
// }
